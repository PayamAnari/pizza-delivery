    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(null=True, unique=True, verbose_name='date of birth')),
                ('delivery_address', models.CharField(max_length=255, null=True, verbose_name='delivery_address')),
